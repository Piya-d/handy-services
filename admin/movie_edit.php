...
$up = "select * from movies where id='$get'";
$ret = mysql_query($up);
...
$query ="UPDATE movies SET language='$language1', title='$title1', date='$date1', image='$image1', url='$url1', cast='$cast1', crew='$crew1', content='$content1' WHERE id=$id";
